    ...
    const match = interfaceFn.find(iFn => iFn.name === fn.name && iFn.inputs.length === fn.inputs.length && iFn.inputs.every((i, index) => {
      if (i.type === "tuple" || i.type === "tuple[]") {
        ...
        return i.type === fn.inputs[index].type && ((_i$components = i.components) === null || _i$components === void 0 ? void 0 : _i$components.every((c, cIndex) => {
          var _fn$inputs$index$comp, _fn$inputs$index$comp2;
          return c.type === ((_fn$inputs$index$comp = fn.inputs[index].components) === null || _fn$inputs$index$comp === void 0 ? void 0 : (_fn$inputs$index$comp2 = _fn$inputs$index$comp[cIndex]) === null || _fn$inputs$index$comp2 === void 0 ? void 0 : _fn$inputs$index$comp2.type);
        }));
      }
...
class Erc20 {
  ...
  async claimTo(destinationAddress, amount, options) {
    var _this$droppable;
    return assertEnabled((_this$droppable = this.droppable) === null || _this$droppable === void 0 ? void 0 : _this$droppable.claim, FEATURE_TOKEN_CLAIM_CONDITIONS_V2).to(destinationAddress, amount, options);
  }
...
class Erc721 {
  ...
  get claimConditions() {
    ...
    return assertEnabled((_this$lazyMintable5 = this.lazyMintable) === null || _this$lazyMintable5 === void 0 ? void 0 : _this$lazyMintable5.claimWithConditions, FEATURE_NFT_CLAIM_CONDITIONS_V2).conditions;
  }
...
class Erc1155 {
  ...
  get claimConditions() {
    var _this$lazyMintable5;
    return assertEnabled((_this$lazyMintable5 = this.lazyMintable) === null || _this$lazyMintable5 === void 0 ? void 0 : _this$lazyMintable5.claimWithConditions, FEATURE_EDITION_CLAIM_CONDITIONS_V2).conditions;
  }
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider), import('./edition-drop-f27adf3d.esm.js'), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider), import('./edition-34040d20.esm.js'), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider), import('./marketplace-cd4d5303.esm.js'), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider), import('./multiwrap-bb0788bd.esm.js'), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider), import('./nft-collection-44b4cf1d.esm.js'), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider), import('./nft-drop-4ef2407b.esm.js'), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider), import('./pack-6a8d8dcd.esm.js'), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider), import('./signature-drop-c6a551a5.esm.js'), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider), import('./split-e2ef532c.esm.js'), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider), import('./token-drop-549c790f.esm.js'), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider), import('./token-fb41b113.esm.js'), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider), import('./vote-ed8aeb06.esm.js'), provider.getNetwork()]);
