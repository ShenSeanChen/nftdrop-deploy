...
import { Q as QueryClientProviderWithDefault, n as neverPersist, r as requiredParamInvariant } from './required-param-785f29a4.esm.js';
...
function useReadonlySDK(readonlyRpcUrl, sdkOptions, storageInterface) {
  return useMemo(() => {
    return new ThirdwebSDK(readonlyRpcUrl, {
      ...sdkOptions,
      readonlySettings: {
        ...(sdkOptions === null || sdkOptions === void 0 ? void 0 : sdkOptions.readonlySettings),
...
function useDisconnect(options) {
  ...
  return async () => {
    ...
    const previousConnector = (data === null || data === void 0 ? void 0 : (_data$data = data.data) === null || _data$data === void 0 ? void 0 : (_data$data$connector = _data$data.connector) === null || _data$data$connector === void 0 ? void 0 : _data$data$connector.previousConnector) || undefined;
        ...
        children: /*#__PURE__*/jsx(Box, {
          ...
          children: /*#__PURE__*/jsx(Menu, {
            ...
            children: !api.isOpen ? null : walletAddress ? /*#__PURE__*/jsxs(Fragment, {
              children: [authConfig !== null && authConfig !== void 0 && authConfig.authUrl && !(user !== null && user !== void 0 && user.address) && !requiresSignIn ? /*#__PURE__*/jsx(MenuItem, {
                ...api.getItemProps({
                  id: "auth",
                  closeOnSelect: false
                }),
